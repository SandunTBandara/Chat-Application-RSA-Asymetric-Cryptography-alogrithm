...
import static chatapplication.AssymetricDrive.encrypt;
import static chatapplication.AssymetricDrive.generateKeyPair;
...
public class Server extends javax.swing.JFrame {
    ...
    private void btnsendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsendActionPerformed
        ...
        try
        {
            ...
            KeyPair pair = AssymetricDrive.generateKeyPair(); //generating the key pair from drive class
            String msgout="";
            msgout =txtbxfield.getText().trim();
            String cipherText = AssymetricDrive.encrypt(msgout, pair.getPublic()); //encrypt the user input message
            dtotpt.writeUTF(cipherText);
